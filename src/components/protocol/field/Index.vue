    ...
    <div class="show-1" v-if="showNum === 6">
        ...
        <div class="lookup" v-if="showLookup">
          ...
          <div class="content-1" v-if="lookupMethod === '1'">
            ...
            <div class="edit-all">
              <div class="data_edit">
                <span style="color:red;margin-left:20px;margin-right:3px;"></span><span style="margin-right:25px;font-size:16px;">数据编辑</span>
              </div>
              <div class="cbutton">
                <button class="btn-1" @click="addListNowPreFn">新建</button>
          ...
          <div class="content-3" v-if="lookupMethod === '3'">
            ...
            <div class="edit-all">
              ...
              <div class="cbutton">
                <button class="btn-1" @click="addListPreFn">新建</button>
                <button class="btn-2" @click="deleteListPreFn">删除</button>
              </div>
              <div class="ctable">
...
export default {
  ...
  data() {
    return {
      ...
      showLookup: false,
      selectLists: ['str_trim', 'str_sub', 'str_add', 'str_regex', 'as', 'notNull', 'isNone', 'in', 'notin', 'add', 'sub', 'multi', 'divide', 'and', 'or', 'eq', 'ne', 'lookup'],
      name: 'str_trim',
      reData: {}, // 将返回的值
  ...
  watch: {
    showLookup() {
      ...
      const initArrLook = {};
      initArrLook.data = data;
      initArrLook.csvname = typeScv;
      this.$store.dispatch('csvInit', initArrLook);
    },
    lookupMethod() {
  ...
  methods: {
    ...
    fileChange(e) {
      ...
      this.show8['@file'] = this.chooseFileName;
