<template>
  <div class='status-content storage'>
    <table class="tit-table">
      <tr>
        <td class="sys-chart-tit">存储</td>
      </tr>
      <tr>
        <td>100%</td>
        <td id="cpuUseFactor">利用率: {{ data[4] }}%</td>
      </tr>
    </table>
    <div class="chart-div" id="cpu_chart" ref="svgHeight">
      <svg preserveAspectRatio="none" class="chart-svg" :viewBox="view" width="100%" height="100%">
        <g transform="translate(0,0)" class="chart-g">
          ...
          <g class="tug">
            <path class="sys-cpu" :d="diskline(datadisk)">
            </path>
            <path class="area area0" fill="url(#area_green0)" :d="diskarea(datadisk)">
            </path>
          </g>
        </g>
      </svg>
