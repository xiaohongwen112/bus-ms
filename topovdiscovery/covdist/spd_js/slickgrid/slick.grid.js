...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function setupColumnSort() {
      $headers.click(function (e) {
        ...
        if (column.sortable) {
          ...
          if(!$(e.target).hasClass("slick-sort-indicator")){
            return;
          }
    ...
    function handleCSBScroll(newScrollTop, newScrollLeft) {
    ...
    $.extend(this, {
      ...
      // Ourself additional function
      "handleCSBScroll": handleCSBScroll,
