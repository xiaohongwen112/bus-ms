...
var provinceList = [
{name:'北京', cityList:[           
{name:'北京市', areaList:['','东城区','西城区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','密云县','延庆县']}
]},
{name:'上海', cityList:[           
{name:'上海市', areaList:['','黄浦区','徐汇区','长宁区','静安区','普陀区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','奉贤区','崇明县']}         
]},
{name:'天津', cityList:[           
{name:'天津市', areaList:['','和平区','河东区','河西区','南开区','河北区','红桥区','东丽区','西青区','津南区','北辰区','武清区','宝坻区','宁河区','静海区','蓟县','滨海新区']}
]},
{name:'重庆', cityList:[           
{name:'重庆市', areaList:['', '万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','渝北区','巴南区','大足区','江津区','合川区','永川区','南川区','璧山区','黔江区','长寿区','綦江县','潼南区','铜梁县','荣昌区','梁平县','城口县','丰都县','垫江县','武隆县','忠县','开县','云阳县','奉节县','巫山县','巫溪县','石柱县','秀山县','酉阳县','彭水县']}
]},
{name:'四川', cityList:[           
{name:'成都市', areaList:['','锦江区','青羊区','金牛区','武侯区','成华区','龙泉驿区','青白江区','新都区','温江区','金堂县','双流县','郫县','大邑县','蒲江县','新津县','都江堰市','彭州市','邛崃市','崇州市']},           
...
{name:'绵阳市', areaList:['','涪城区','游仙区','三台县','盐亭县','安县','梓潼县','北川县','平武县','江油市']},           
{name:'广元市', areaList:['','利州区','昭化区','朝天区','旺苍县','青川县','剑阁县','苍溪县']},           
{name:'遂宁市', areaList:['','船山区','安居区','蓬溪县','射洪县','大英县']},           
{name:'内江市', areaList:['','市中区','东兴区','经济开发区','威远县','资中县','隆昌县']},           
{name:'乐山市', areaList:['','市中区','沙湾区','五通桥区','金口河区','犍为县','井研县','夹江县','沐川县','峨边县','马边县','峨眉山市']},           
{name:'南充市', areaList:['','顺庆区','高坪区','嘉陵区','南部县','营山县','蓬安县','仪陇县','西充县','阆中市']},           
{name:'眉山市', areaList:['','东坡区','仁寿县','彭山区','洪雅县','丹棱县','青神县']},           
{name:'宜宾市', areaList:['','翠屏区','宜宾县','南溪区','江安县','长宁县','高县','珙县','筠连县','兴文县','屏山县']},           
...
{name:'阿坝州', areaList:['','汶川县','理县','茂县','松潘县','九寨沟县','金川县','小金县','黑水县','马尔康县','壤塘县','阿坝县','若尔盖县','红原县']},           
{name:'甘孜州', areaList:['','康定县','泸定县','丹巴县','九龙县','雅江县','道孚县','炉霍县','甘孜县','新龙县','德格县','白玉县','石渠县','色达县','理塘县','巴塘县','乡城县','稻城县','得荣县']},           
{name:'凉山州', areaList:['','西昌市','木里县','盐源县','德昌县','会理县','会东县','宁南县','普格县','布拖县','金阳县','昭觉县','喜德县','冕宁县','越西县','甘洛县','美姑县','雷波县']}
]},
{name:'贵州', cityList:[           
{name:'贵阳市', areaList:['','南明区','云岩区','花溪区','乌当区','白云区', '观山湖区','开阳县','息烽县','修文县','清镇市']},           
{name:'六盘水市', areaList:['钟山区','六枝特区','水城县','盘县']},           
{name:'遵义市', areaList:['','红花岗区','汇川区','遵义县','桐梓县','绥阳县','正安县','道真县','务川县','凤冈县','湄潭县','余庆县','习水县','赤水市','仁怀市']},           
{name:'安顺市', areaList:['','西秀区','平坝区','普定县','镇宁县','关岭县','紫云县']},           
{name:'铜仁市', areaList:['', '碧江区','江口县','玉屏县','石阡县','思南县','印江县','德江县','沿河县','松桃县','万山区']},                      
{name:'毕节市', areaList:['','七星关区','大方县','黔西县','金沙县','织金县','纳雍县', '威宁县','赫章县']},  
{name:'黔西南州', areaList:['','兴义市','兴仁县','普安县','晴隆县','贞丰县','望谟县','册亨县','安龙县']},         
{name:'黔东南州', areaList:['','凯里市','黄平县','施秉县','三穗县','镇远县','岑巩县','天柱县','锦屏县','剑河县','台江县','黎平县','榕江县','从江县','雷山县','麻江县','丹寨县']},           
{name:'黔南州', areaList:['','都匀市','福泉市','荔波县','贵定县','瓮安县','独山县','平塘县','罗甸县','长顺县','龙里县','惠水县','三都县']}
]},
{name:'云南', cityList:[           
{name:'昆明市', areaList:['','五华区','盘龙区','官渡区','西山区','东川区','呈贡区','晋宁县','富民县','宜良县','石林县','嵩明县','禄劝县','寻甸县','安宁市']},           
{name:'曲靖市', areaList:['','麒麟区','马龙县','陆良县','师宗县','罗平县','富源县','会泽县','沾益县','宣威市']},           
{name:'玉溪市', areaList:['','红塔区','江川县','澄江县','通海县','华宁县','易门县','峨山县','新平县','元江县']},           
{name:'保山市', areaList:['','隆阳区','施甸县','腾冲市','龙陵县','昌宁县']},           
{name:'昭通市', areaList:['','昭阳区','鲁甸县','巧家县','盐津县','大关县','永善县','绥江县','镇雄县','彝良县','威信县','水富县']},           
{name:'丽江市', areaList:['','古城区','玉龙县','永胜县','华坪县','宁蒗县']},           
{name:'普洱市', areaList:['','思茅区','宁洱县','墨江县','景东县','景谷县','镇沅县','江城县','孟连县','澜沧县','西盟县']},           
{name:'临沧市', areaList:['','临翔区','凤庆县','云县','永德县','镇康县','双江县','耿马县','沧源县']},           
{name:'楚雄州', areaList:['','楚雄市','双柏县','牟定县','南华县','姚安县','大姚县','永仁县','元谋县','武定县','禄丰县']},           
{name:'红河州', areaList:['','个旧市','开远市','蒙自县','屏边县','建水县','石屏县','弥勒市','泸西县','元阳县','红河县','绿春县','河口县','金平县']},           
{name:'文山州', areaList:['','文山市','砚山县','西畴县','麻栗坡县','马关县','丘北县','广南县','富宁县']},           
{name:'西双版纳州', areaList:['','景洪市','勐海县','勐腊县']},           
{name:'大理州', areaList:['','大理市','漾濞县','祥云县','宾川县','弥渡县','南涧县','巍山县','永平县','云龙县','洱源县','剑川县','鹤庆县']},           
{name:'德宏州', areaList:['','瑞丽市','芒市','梁河县','盈江县','陇川县']},           
{name:'怒江州', areaList:['','泸水县','福贡县','贡山县','兰坪县']},           
{name:'迪庆州', areaList:['','香格里拉县','德钦县','维西县']}
]},
{name:'西藏', cityList:[           
...
{name:'河南', cityList:[           
{name:'郑州市', areaList:['','中原区','二七区','管城区','金水区','上街区','惠济区','中牟县','巩义市','荥阳市','新密市','新郑市','登封市']},           
{name:'开封市', areaList:['','龙亭区','顺河区','鼓楼区','禹王台区','祥符区','杞县','通许县','尉氏县','兰考县']},           
{name:'洛阳市', areaList:['','老城区','西工区','涧西区','吉利区','洛龙区', '瀍河区','孟津县','新安县','栾川县','嵩县','汝阳县','宜阳县','洛宁县','伊川县','偃师市']},           
...
{name:'三门峡市', areaList:['','湖滨区','渑池县','陕州区','卢氏县','义马市','灵宝市']},           
...
{name:'宜昌市', areaList:['','西陵区','伍家岗区','点军区','猇亭区','夷陵区','远安县','兴山县','秭归县','长阳县','五峰县','宜都市','当阳市','枝江市']},           
{name:'襄樊市', areaList:['','襄城区','樊城区','襄州区','南漳县','谷城县','保康县','枣阳市','宜城市','老河口市']},           
...
{name:'恩施州', areaList:['','恩施市','利川市','建始县','巴东县','宣恩县','咸丰县','来凤县','鹤峰县']},           
{name:'仙桃市', areaList:['']},
{name:'潜江市', areaList:['']},
{name:'天门市', areaList:['']},
{name:'神农架林区', areaList:['']},
...
{name:'邵阳市', areaList:['','双清区','大祥区','北塔区','邵东县','新邵县','邵阳县','隆回县','洞口县','绥宁县','新宁县','城步县','武冈市']},           
...
{name:'益阳市', areaList:['','资阳区','赫山区', '大通湖区','南县','桃江县','安化县','沅江市']},           
{name:'郴州市', areaList:['','北湖区','苏仙区','桂阳县','宜章县','永兴县','嘉禾县','临武县','汝城县','桂东县','安仁县','资兴市']},           
{name:'永州市', areaList:['','零陵区','冷水滩区','祁阳县','东安县','双牌县','道县','江永县','宁远县','蓝山县','新田县','江华县','金洞区','回龙圩区']},           
{name:'怀化市', areaList:['','鹤城区','中方县','沅陵县','辰溪县','溆浦县','会同县','麻阳县','新晃县','芷江县','靖州县','通道县','洪江市']},           
{name:'娄底市', areaList:['','娄星区','双峰县','新化县','冷水江市','涟源市']},           
{name:'湘西州', areaList:['','吉首市','泸溪县','凤凰县','花垣县','保靖县','古丈县','永顺县','龙山县']}
]},
{name:'广东', cityList:[           
{name:'广州市', areaList:['','荔湾区','越秀区','海珠区','天河区','白云区','黄埔区','花都区', '番禺区', '南沙区','增城市','从化市']},           
{name:'韶关市', areaList:['','武江区','浈江区','曲江区','始兴县','仁化县','翁源县','乳源县','新丰县','乐昌市','南雄市']},           
...
{name:'清远市', areaList:['','清城区','佛冈县','阳山县','连山县','连南县','清新区','英德市','连州市']},           
{name:'东莞市', areaList:['']},           
{name:'中山市', areaList:['']},           
{name:'潮州市', areaList:['','湘桥区','潮安县','饶平县']},           
{name:'揭阳市', areaList:['','榕城区','揭东县','揭西县','惠来县','普宁市']},           
{name:'云浮市', areaList:['','云城区','新兴县','郁南县','云安区','罗定市']}
]},
{name:'广西', cityList:[           
{name:'南宁市', areaList:['','青秀区','兴宁区','江南区','西乡塘区','良庆区','邕宁区','武鸣县','隆安县','马山县','上林县','宾阳县','横县']},           
{name:'柳州市', areaList:['','柳北区','城中区','鱼峰区','柳南区','柳江县','柳城县','鹿寨县','融安县','融水县','三江县']},           
{name:'桂林市', areaList:['','象山区','秀峰区','叠彩区','七星区','雁山区','阳朔县','临桂区','灵川县','全州县','兴安县','永福县','灌阳县','龙胜县','资源县','平乐县','荔蒲县','恭城县']},           
{name:'梧州市', areaList:['','长洲区','万秀区','龙圩区','苍梧县','藤县','蒙山县','岑溪市']},           
...
{name:'百色市', areaList:['','右江区','田阳县','田东县','平果县','德保县','靖西县','那坡县','凌云县','乐业县','田林县','西林县','隆林县']},           
{name:'贺州市', areaList:['','八步区','平桂区','昭平县','钟山县','富川县']},           
{name:'河池市', areaList:['','金城江区','南丹县','天峨县','凤山县','东兰县','罗城县','环江县','巴马县','都安县','大化县','宜州市']},           
{name:'来宾市', areaList:['','兴宾区','忻城县','象州县','武宣县','金秀县','合山市']},           
...
{name:'咸阳市', areaList:['','秦都区','渭城区','三原县','泾阳县','乾县','礼泉县','永寿县','彬县','长武县','旬邑县','淳化县','武功县','兴平市']},           
...
{name:'安康市', areaList:['','汉滨区','高新区','汉阴县','石泉县','宁陕县','紫阳县','岚皋县','平利县','镇坪县','旬阳县','白河县']},           
{name:'商洛市', areaList:['','商州区','洛南县','丹凤县','商南县','山阳县','镇安县','柞水县']},
{name:'杨凌区', areaList:['']}
]},
{name:'甘肃', cityList:[           
{name:'兰州市', areaList:['','城关区','七里河区','西固区','安宁区','红古区','永登县','皋兰县','榆中县']},           
{name:'嘉峪关市', areaList:['峪泉镇','文殊镇','新城镇']},           
{name:'金昌市', areaList:['','金川区','永昌县']},           
{name:'白银市', areaList:['','白银区','平川区','靖远县','会宁县','景泰县']},           
{name:'天水市', areaList:['','秦州区','麦积区','清水县','秦安县','甘谷县','武山县','张家川县']},           
{name:'武威市', areaList:['','凉州区','民勤县','古浪县','天祝县']},           
{name:'张掖市', areaList:['','甘州区','肃南裕县','民乐县','临泽县','高台县','山丹县']},           
{name:'平凉市', areaList:['','崆峒区','泾川县','灵台县','崇信县','华亭县','庄浪县','静宁县']},           
{name:'酒泉市', areaList:['','肃州区','金塔县','肃北县','阿克塞县','玉门市','敦煌市','瓜州县']},           
...
{name:'临夏州', areaList:['','临夏市','临夏县','康乐县','永靖县','广河县','和政县','东乡县','积石山县']},           
{name:'甘南州', areaList:['','合作市','临潭县','卓尼县','舟曲县','迭部县','玛曲县','碌曲县','夏河县']}
]},
{name:'青海', cityList:[           
{name:'西宁市', areaList:['','城东区','城中区','城西区','城北区','大通县','湟中县','湟源县']},           
{name:'海东市', areaList:['','平安区','民和县','乐都区','互助县','化隆县','循化县']},           
{name:'海北州', areaList:['','门源县','祁连县','海晏县','刚察县']},           
{name:'黄南州', areaList:['','同仁县','尖扎县','泽库县','河南县']},           
{name:'海南州', areaList:['','共和县','同德县','贵德县','兴海县','贵南县']},           
{name:'果洛州', areaList:['','玛沁县','班玛县','甘德县','达日县','久治县','玛多县']},           
{name:'玉树州', areaList:['','玉树市','杂多县','称多县','治多县','囊谦县','曲麻莱县']},           
{name:'海西州', areaList:['','德令哈市','格尔木市','乌兰县','都兰县','天峻县']}
]},
{name:'宁夏', cityList:[           
...
{name:'吐鲁番地区', areaList:['','高昌区','鄯善县','托克逊县']},           
{name:'哈密地区', areaList:['','哈密市','巴里坤县','伊吾县']},           
{name:'昌吉州', areaList:['昌吉市','阜康市','呼图壁县','玛纳斯县','奇台县','吉木萨尔县','木垒县']},           
{name:'博尔塔拉州', areaList:['','博乐市','精河县','温泉县','阿里山口市']},           
{name:'巴音郭楞州', areaList:['','库尔勒市','轮台县','尉犁县','若羌县','且末县','焉耆县','和静县','和硕县','博湖县']},           
{name:'阿克苏地区', areaList:['','阿克苏市','温宿县','库车县','沙雅县','新和县','拜城县','乌什县','阿瓦提县','柯坪县']},           
{name:'克孜勒苏柯尔克孜州', areaList:['','阿图什市','阿克陶县','阿合奇县','乌恰县']},           
{name:'喀什地区', areaList:['','喀什市','疏附县','疏勒县','英吉沙县','泽普县','莎车县','叶城县','麦盖提县','岳普湖县','伽师县','巴楚县','库什库尔干县']},           
{name:'和田地区', areaList:['','和田市','和田县','墨玉县','皮山县','洛浦县','策勒县','于田县','民丰县']},           
{name:'伊犁州', areaList:['','伊宁市','奎屯市', '霍尔果斯市','伊宁县','察布查尔县','霍城县','巩留县','新源县','昭苏县','特克斯县','尼勒克县']},           
{name:'塔城地区', areaList:['','塔城市','乌苏市','额敏县','沙湾县','托里县','裕民县','和布县']},           
...
{name:'河北', cityList:[           
{name:'石家庄市', areaList:['','长安区','桥西区','新华区','井陉矿区','裕华区','井陉县','正定县','栾城区','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','赵县','辛集市','藁城区','晋州市','新乐市','鹿泉区']},           
{name:'唐山市', areaList:['','路南区','路北区','古冶区','开平区','丰南区','丰润区','曹妃甸区','滦县','滦南县','乐亭县','迁西县','玉田县','遵化市','迁安市']},           
{name:'秦皇岛市', areaList:['','海港区','山海关区','北戴河区','青龙县','昌黎县','抚宁县','卢龙县']},           
{name:'邯郸市', areaList:['','邯山区','丛台区','复兴区','峰峰矿区','邯郸县','临漳县','成安县','大名县','涉县','磁县','肥乡县','永年县','邱县','鸡泽县','广平县','馆陶县','魏县','曲周县','武安市']},           
{name:'邢台市', areaList:['','桥东区','桥西区','邢台县','临城县','内丘县','柏乡县','隆尧县','任县','南和县','宁晋县','巨鹿县','新和县','广宗县','平乡县','威县','清河县','临西县','南宫市','沙河市']},           
{name:'保定市', areaList:['','竞秀区','莲池区','徐水区','满城区','清苑区','涞水县','阜平县','定兴县','唐县','高阳县','容城县','涞源县','望都县','安新县','易县','曲阳县','蠡县','顺平县','博野县','雄县','涿州市','定州市','安国市','高碑店市']},           
{name:'张家口市', areaList:['','桥东区','桥西区','宣化区','下花园区','宣化县','张北县','康保县','沽源县','尚义县','蔚县','阳原县','怀安县','万全县','怀来县','涿鹿县','赤城县','崇礼县']},           
{name:'承德市', areaList:['','双桥区','双滦区','鹰手营子矿区','承德县','兴隆县','平泉县','滦平县','隆化县','丰宁县','宽城县','围场县']},           
{name:'沧州市', areaList:['','新华区','运河区','沧县','青县','东光县','海兴县','盐山县','肃宁县','南皮县','吴桥县','献县','孟村县','泊头市','任丘市','黄骅市','河间市']},           
{name:'廊坊市', areaList:['','安次区','广阳区','固安县','永清县','香河县','大城县','文安县','大厂县','霸州市','三河市']},           
...
{name:'运城市', areaList:['','盐湖区','临猗县','万荣县','闻喜县','稷山县','新绛县','绛县','夏县','垣曲县','平陆县','芮城县','永济市','河津市']},           
...
{name:'呼伦贝尔市', areaList:['','海拉尔区','阿荣旗','莫力达瓦旗','鄂伦春旗','鄂温克旗','陈巴尔虎旗','新巴尔虎左旗','新巴尔虎右旗','满洲里市','牙克石市','扎兰屯市','额尔古纳市','根河市']},           
...
{name:'徐州市', areaList:['','鼓楼区','云龙区','贾汪区','泉山区','丰县','沛县','铜山县','睢宁县','新沂市','邳州市']},           
{name:'常州市', areaList:['','天宁区','钟楼区','新北区','武进区','溧阳市','金坛市']},           
{name:'苏州市', areaList:['','姑苏区','虎丘区','吴中区','相城区','常熟市','张家港市','昆山市','吴江区','太仓市']},           
{name:'南通市', areaList:['','崇川区','港闸区','海安县','如东县','启东市','如皋市','通州市','海门市']},           
{name:'连云港市', areaList:['','连云区','海州区','赣榆县','东海县','灌云县','灌南县']},           
{name:'淮安市', areaList:['','清河区','淮安区','淮阴区','清浦区','涟水县','洪泽县','盱眙县','金湖县']},           
{name:'盐城市', areaList:['','亭湖区','盐都区','响水县','滨海县','阜宁县','射阳县','建湖县','东台市','大丰区']},           
{name:'扬州市', areaList:['','广陵区','邗江区','江都区','宝应县','仪征市','高邮市']},           
{name:'镇江市', areaList:['','京口区','润州区','丹徒区','丹阳市','扬中市','句容市']},           
{name:'泰州市', areaList:['','海陵区','高港区','兴化市','靖江市','泰兴市','姜堰区']},           
...
{name:'嘉兴市', areaList:['','秀城区','南湖区','嘉善县','海盐县','海宁市','平湖市','桐乡市']},           
...
{name:'丽水市', areaList:['','莲都区','青田县','缙云县','遂昌县','松阳县','云和县','庆元县','景宁县','龙泉市']}
]},
{name:'安徽', cityList:[           
{name:'合肥市', areaList:['','瑶海区','庐阳区','蜀山区','包河区','长丰县','肥东县','肥西县','庐江县','巢湖市']},           
{name:'芜湖市', areaList:['','镜湖区','鸠江区','弋江区','三山区','无为县','芜湖县','繁昌县','南陵县']},           
...
{name:'安庆市', areaList:['','迎江区','大观区','宜秀区','怀宁县','枞阳县','潜山县','太湖县','宿松县','望江县','岳西县','桐城市']},           
...
{name:'福建', cityList:[           
{name:'福州市', areaList:['','鼓楼区','台江区','仓山区','马尾区','晋安区','闽侯县','连江县','罗源县','闽清县','永泰县','福清市','长乐市']},           
...
{name:'宁德市', areaList:['','蕉城区','东侨新区','霞浦县','古田县','屏南县','寿宁县','周宁县','柘荣县','福安市','福鼎市']},
{name:'平潭市', areaList:['','潭城','苏澳','流水','澳前','北厝','平原','敖东']}
]},
{name:'江西', cityList:[           
{name:'南昌市', areaList:['','东湖区','西湖区','青云谱区','湾里区','青山湖区','南昌县','新建区','安义县','进贤县']},           
{name:'景德镇市', areaList:['','昌江区','珠山区','浮梁县','乐平市']},           
{name:'萍乡市', areaList:['','安源区','湘东区','莲花县','上栗县','芦溪县']},           
{name:'九江市', areaList:['','庐山区','浔阳区','九江县','武宁县','修水县','永修县','德安县','星子县','都昌县','湖口县','彭泽县','瑞昌市','共青城市']},           
{name:'新余市', areaList:['','渝水区','分宜县']},           
{name:'鹰潭市', areaList:['','月湖区','余江县','贵溪市']},           
{name:'赣州市', areaList:['','章贡区','南康区','赣县','信丰县','大余县','上犹县','崇义县','安远县','龙南县','定南县','全南县','宁都县','于都县','兴国县','会昌县','寻乌县','石城县','瑞金市']},           
...
{name:'青岛市', areaList:['','市南区','市北区','黄岛区','崂山区','李沧区','城阳区','胶州市','即墨市','平度市','莱西市']},           
...
{name:'济宁市', areaList:['','任城区','微山县','鱼台县','金乡县','嘉祥县','汶上县','泗水县','梁山县','曲阜市','兖州市','邹城市']},           
...
{name:'临沂市', areaList:['','兰山区','罗庄区','河东区','沂南县','郯城县','沂水县','费县','平邑县','莒南县','蒙阴县','临沭县','兰陵县']},           
...
{name:'牡丹区', areaList:['','牡丹区','曹县','单县','成武县','巨野县','郓城县','鄄城县','定陶县','东明县']}
]},
{name:'辽宁', cityList:[           
{name:'沈阳市', areaList:['','和平区','沈河区','大东区','皇姑区','铁西区','苏家屯区','浑南区','沈北新区','于洪区','辽中县','康平县','法库县','新民市']},           
{name:'大连市', areaList:['','中山区','西岗区','沙河口区','甘井子区','旅顺口区','金州区','长海县','瓦房店市','普兰店市','庄河市']},           
{name:'鞍山市', areaList:['','铁东区','铁西区','立山区','千山区','台安县','岫岩县','海城市']},           
{name:'抚顺市', areaList:['','新抚区','东洲区','望花区','顺城区','抚顺县','新宾县','清原县']},           
{name:'本溪市', areaList:['','平山区','溪湖区','明山区','南芬区','本溪县','桓仁县']},           
{name:'丹东市', areaList:['','元宝区','振兴区','振安区','宽甸县','东港市','凤城市']},           
{name:'锦州市', areaList:['','古塔区','凌河区','太和区','松山新区','黑山县','义县','凌海市','北镇市']},           
{name:'营口市', areaList:['','站前区','西市区','鲅鱼圈区','老边区','盖州市','大石桥市']},           
{name:'阜新市', areaList:['','海州区','新邱区','太平区','清河门区','细河区','阜新县','彰武县']},           
...
{name:'朝阳市', areaList:['','双塔区','龙城区','朝阳县','建平县','北票市','凌源市','喀喇沁左翼县']},           
...
{name:'四平市', areaList:['','铁西区','铁东区','梨树县','伊通县','双辽市']},           
{name:'辽源市', areaList:['','龙山区','西安区','东丰县','东辽县']},           
{name:'通化市', areaList:['','东昌区','二道江区','通化县','辉南县','柳河县','集安市']},           
{name:'白山市', areaList:['','八道江区','抚松县','靖宇县','长白县','江源县','临江市']},           
{name:'松原市', areaList:['','宁江区','长岭县','乾安县','扶余县']},           
{name:'白城市', areaList:['','洮北区','镇赉县','通榆县','洮南市','大安市']},           
{name:'延边州', areaList:['','延吉市','图们市','敦化市','珲春市','龙井市','和龙市','汪清县','安图县']}
]},
{name:'黑龙江', cityList:[           
{name:'哈尔滨市', areaList:['','道里区','南岗区','道外区','香坊区','平房区','松北区','呼兰区','阿城区','双城区','依兰县','方正县','宾县','巴彦县','木兰县','通河县','延寿县','尚志市','五常市']},           
{name:'齐齐哈尔市', areaList:['','龙沙区','建华区','铁锋区','昂昂溪区','富拉尔基区','碾子山区','梅里斯达区','龙江县','依安县','泰来县','甘南县','富裕县','克山县','克东县','拜泉县','讷河市']},           
...
{name:'大庆市', areaList:['','萨尔图区','龙凤区','让胡路区','红岗区','大同区','肇州县','肇源县','林甸县','杜尔伯特县']},           
{name:'伊春市', areaList:['','伊春区','南岔区','友好区','西林区','翠峦区','新青区','美溪区','金山屯区','五营区','乌马河区','汤旺河区','带岭区','乌伊岭区','红星区','上甘岭区','嘉荫县','铁力市']},           
{name:'佳木斯市', areaList:['','向阳区','前进区','东风区','郊区','桦南县','桦川县','汤原县','抚远县','同江市','富锦市']},           
...
{name:'五指山市', areaList:['','通什镇','南圣镇','毛阳镇','番阳镇']},
{name:'文昌市', areaList:['','文城镇','重兴镇','蓬莱镇','会文镇','东路镇','潭牛镇','东阁镇','文教镇','东郊镇','龙楼镇','昌洒镇','翁田镇','抱罗镇','冯坡镇','锦山镇','铺前镇','公坡镇']},
{name:'琼海市', areaList:['','嘉积镇','万泉镇','石壁镇','中原镇','博鳌镇','阳江镇','龙江镇','潭门镇','塔洋镇','长坡镇','大路镇','会山镇']},
{name:'万宁市', areaList:['','万城镇','龙滚镇','山根镇','和乐镇','后安镇','大茂镇','东奥镇','礼纪镇','长丰镇','北大镇','南桥镇','三更罗镇']},
{name:'东方市', areaList:['','八所镇','东河镇','大田镇','感城镇','板桥镇','三家镇','四更镇','新龙镇']},
{name:'定安县', areaList:['']},
{name:'屯昌县', areaList:['']},
{name:'澄迈县', areaList:['']},
{name:'临高县', areaList:['']},
