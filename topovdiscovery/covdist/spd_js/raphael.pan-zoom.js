...
(function () {
    ...
    PanZoom = function (el, options) {
        ...
        container.onmousedown = function (e) {
            ...
            //only drag on svg, not circle, path ... 
            if(evt.target.tagName != 'svg'){
                return;
            }
            var which = e.which || e.button;
            if(which != 1){
                return ;
            }
        ...
        function setZoom(zoom, centerPoint) {
            if (!me.enabled) return false;
            me.currZoom = zoom;
            if (me.currZoom < settings.minZoom) {
                me.currZoom = settings.minZoom;
        ...
        function repaint() {
            ...
            if(options.viewboxChangeCallback){
                options.viewboxChangeCallback([me.currPos.x, me.currPos.y, newWidth, newHeight])
            }
        }
    };
